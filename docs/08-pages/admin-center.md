...
| **Mark league finished** | Manual, and gated on the last match having started — nothing records a match ending. Reversible. **Lives on League Details until this page is built.** |
